...
if st.session_state.page=='home':
    ...
    if st.session_state.sel_op=='select movie & rate':
        ...
        if st.button('add rating'):
            ...
            rate={'movie':st.session_state.mov_name_sel,'rate':st.session_state.rate_mov,'genre':st.session_state.movlist[st.session_state.mov_name_sel]['genre'],'view':len(st.session_state.views_mov)}
        ...
        st.subheader("get recommandations")
        def recom_gen():
        ...
        st.subheader("search the movies")
    ...
    st.session_state.uspass=st.text_input('enter your password to protect your account')
    if st.session_state.uspass==st.session_state.uspassword:
    ...
    st.session_state.pas=st.text_input('enter your password to protect your account')
    if st.session_state.pas==st.session_state.uspassword:
